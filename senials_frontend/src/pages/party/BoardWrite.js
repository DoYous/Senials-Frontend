        ...
        <div className={styles.centerContainer}>
            <div className={styles.separator}>
                ...
                <span className={`${styles.firstFont}`}>
                    <span className={styles.pointColor}>모임</span>을 만들어주세요!
                </span>
            </div>
            ...
            <textarea className={`${styles.formTextarea} ${styles.marginBottom}`} placeholder='모임을 소개해주세요! 준비물, 마음가짐 등 자유롭게 기입해주세요!'></textarea>
